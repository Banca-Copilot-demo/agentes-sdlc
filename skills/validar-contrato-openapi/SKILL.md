...
description: Valida un contrato OpenAPI contra los lineamientos de APIs de BCP -nomenclatura de rutas, versionado en la URL, codigos de error obligatorios y cabeceras de trazabilidad-. Usalo cuando alguien pida revisar, validar o auditar una especificacion OpenAPI o Swagger, o antes de publicar una API nueva.
license: Proprietary
metadata:
  id: bcp.sdlc.validar-contrato-openapi
...
# Validar un contrato OpenAPI contra los lineamientos de BCP
